	...
	return (
		...
		>
			...
			<div className="flex flex-col items-center gap-4">
				<div className="bg-accent-light dark:bg-jacarta-700 p-4 rounded-full">
				...
				<Button onClick={open} className="mt-2 bg-accent-lighter hover:bg-accent-lighter-dark text-white">
					Select PDF
				</Button>
